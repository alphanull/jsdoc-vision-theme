...
export function publish(taffyData, opts, tutorials) { // eslint-disable-line max-statements
    ...
    view.description = templateConfig.description || 'This is the autogenerated JSDoc documentation.';
    ...
    if (outputSourceFiles) {
        utils.generateSourceFiles(sourceFiles, opts.encoding, outdir);
    }
    ...
    function generateTutorial(title, tutorial, filename) {
        ...
        const tutorialPath = path.join(outdir, filename),
              tutorialData = {
                  title: templateConfig.tutorialHeader ? title : null,
        ...
        view.desc = templateConfig.description || 'This is the autogenerated JSDoc documentation.';
