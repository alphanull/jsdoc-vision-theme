...
/**
 * @typedef  {Object} module:util/publisher~globalOptions    Options for the publisher. These can be changed on a global basis by the configure() method.
...
/**
 * @typedef  {Object} module:util/publisher~subscriberObject Structure of a single Subscriber
 ...
 * @property {Object<module:util/publisher~subscriberOptions>} options    The various subscriber options.
 */

/**
 * @typedef  {Object} module:util/publisher~subscriberOptions    Options for the subscriber. These can be used by publish or subscribe commands, except when noted.
 ...
 * @private
 * @memberof module:util/publisher
 * @type {module:util/publisher~globalOptions}
 */
const globalOptions = {
    async: true,
 ...
 * @private
 * @memberof module:util/publisher
 * @type     {Map<module:util/publisher~subscriberObject>}
 * @property {module:util/publisher~subscriberObject}      subscriberObject  The subscriber object containing all necessary information.
 */
 ...
 * @memberof module:util/publisher
 * @param {Object<module:util/publisher~globalOptions>} options  An object containing various options.
 */
 ...
 * @private
 * @memberof module:util/publisher
 * @param   {module:util/publisher~subscriberObject} subscriber    The subscriber to execute.
 ...
 * @returns {module:util/publisher~subscriberObject[]}                Array with matching subscribers.
 */
 ...
 * @memberof module:util/publisher
 * @param {string[]}                                       topicArray     Hold eachs segments of the topic in an array, also reflecting the current scope.
 * @param {Object<module:util/publisher~subscriberObject>} subscriber     The subscriber to add.
 ...
 * @memberof module:util/publisher
 * @param {string[]}                                       topicArray     Hold eachs segments of the topic in an array, also reflecting the current scope.
 * @param {Object<module:util/publisher~subscriberObject>} subscriber     The subscriber to remove.
 * @param {Object}                                         subscriptions  Part of the subscriptions tree, reflecting the current scope.
 */
