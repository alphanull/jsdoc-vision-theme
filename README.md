...
- **SEO-friendly** – Automatically generated meta descriptions - even for source code and tutorial pages, as well as support for generating canonical links. Can also automatically generate sitemaps.
...
```json
{
    ...
    "templates": {
        ...
        "sitemap": "https://visionplayer.io/docs/",
        "sort": false,
        "logoText": false,
...
| `sitemap`              | `false`       | If set to a string (base URL), generates a `sitemap.xml` file in the output root. The string represents the base URL for all sitemap entries (e.g., `"https://visionplayer.io/docs/"`). |
